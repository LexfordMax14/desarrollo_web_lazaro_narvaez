...
function renderizarTabla(miembros, totalMiembros) {
    ...
    const columnas = ['Nombre', 'Email', 'Teléfono', 'Fecha Registro'];
    ...
    miembros.forEach(miembro => {
        ...
        fila.addEventListener('click', () => {
            window.location.href = '/detalle.html?id=' + miembro.id;
        });
    ...
    anterior.addEventListener('click', () => { paginaActual -= 1; cargarMiembros(); });
    ...
    siguiente.addEventListener('click', () => { paginaActual += 1; cargarMiembros(); });
